# here main thing we cannot consider that transCount parameter and our general case will work.
...
class Solution:
    ...
    def BestTime(self,prices,currentDay , canBuy, memo):
        ...
        if canBuy:
            ...
            ideal = self.BestTime(prices,currentDay + 1,canBuy,  memo) # we sit ideal at that day
            sell = prices[currentDay] + self.BestTime(prices,currentDay + 1,True,  memo) # we sell the stock at that day
